...
export default function FeaturedCarousel() {
    ...
    // progress bar state (styled-jsx yerine transition ile)
    ...
    // progress genişliğini animasyonla doldur
    useEffect(() => {
        ...
        return (
            <section className="relative">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl md:text-2xl font-semibold">Öne Çıkan Ürünler</h2>
    ...
    return (
        <section className="relative">
            {/* başlık + progress (styled-jsx yok) */}
