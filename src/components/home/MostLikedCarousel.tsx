...
type P = Pick<Product, "id" | "name" | "slug" | "price" | "image_url" | "image_alt"> & { likes?: number };
        ...
        return (
            <section className="relative">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl md:text-2xl font-semibold">En Çok Beğenilen</h2>
                    <span className="h-2 w-24 rounded bg-neutral-200 animate-pulse"/>
                </div>
            ...
            >
                ...
                >
                    {safeItems.map((p, i) => (
                        ...
                        >
                            <div
                                className="absolute left-2 top-2 z-10 flex items-center gap-1 rounded-full px-2 py-1 text-[10px] font-semibold text-white bg-gradient-to-r from-fuchsia-600 to-violet-600 shadow">
                                ...
                                {typeof p.likes === "number" ? `${p.likes}` : "Popüler"}
                            </div>
